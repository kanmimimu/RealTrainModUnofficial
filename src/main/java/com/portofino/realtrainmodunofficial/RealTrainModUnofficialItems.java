...
public class RealTrainModUnofficialItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(Registries.ITEM, RealTrainModUnofficial.MODID);

    public static final RegistryObject<InstalledObjectItem> CROSSING_GATE_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<MarkerItem> MARKER_ITEM = ITEMS.register(
        "marker", () -> new MarkerItem(jp.ngt.rtm.rail.RTMRailBlocks.MARKER.get(), false)
    );
    public static final RegistryObject<MarkerItem> MARKER_DIAGONAL_ITEM = ITEMS.register(
        "marker_diagonal", () -> new MarkerItem(jp.ngt.rtm.rail.RTMRailBlocks.MARKER.get(), true)
    );
    public static final RegistryObject<MarkerItem> MARKER_SWITCH_ITEM = ITEMS.register(
        "marker_switch", () -> new MarkerItem(jp.ngt.rtm.rail.RTMRailBlocks.MARKER_SWITCH.get(), false)
    );
    public static final RegistryObject<MarkerItem> MARKER_SWITCH_DIAGONAL_ITEM = ITEMS.register(
        "marker_switch_diagonal", () -> new MarkerItem(jp.ngt.rtm.rail.RTMRailBlocks.MARKER_SWITCH.get(), true)
    );
    public static final RegistryObject<RailItem> RAIL_ITEM = ITEMS.register(
        "rail", RailItem::new
    );
    public static final RegistryObject<TrainItem> TRAIN_ITEM = ITEMS.register(
        "train", () -> new TrainItem(TrainItem.Category.ELECTRIC)
    );
    // 試験用車両(test_train)はユーザー要望により削除。
    public static final RegistryObject<TrainVehicleItem> TRAIN_VEHICLE_ITEM = ITEMS.register(
        "train_vehicle", TrainVehicleItem::new
    );
    public static final RegistryObject<CarItem> CAR_ITEM = ITEMS.register(
        "car", CarItem::new
    );
    //本家 itemMotorman (運転士)。列車に使うと運転台に乗り、信号/ダイヤ/マクロで自動運転する
    public static final RegistryObject<com.portofino.realtrainmodunofficial.item.MotormanItem> MOTORMAN_ITEM = ITEMS.register(
        "motorman", com.portofino.realtrainmodunofficial.item.MotormanItem::new
    );
    public static final RegistryObject<IcCardItem> IC_CARD_ITEM = ITEMS.register(
        "ic_card", IcCardItem::new
    );
    //MCTE 互換ミニチュア (最低限: ブロック範囲キャプチャ。NGTO Builder が使用)
    public static final RegistryObject<MiniatureItem> MINIATURE_ITEM = ITEMS.register(
        "miniature", MiniatureItem::new
    );
    public static final RegistryObject<CrowbarItem> CROWBAR_ITEM = ITEMS.register(
        "crowbar", CrowbarItem::new
    );
    //本家 ItemWrench 忠実移植版 (旧 WrenchItem はレガシー系の参照維持のため残置)
    public static final RegistryObject<RtmWrenchItem> WRENCH_ITEM = ITEMS.register(
        "wrench", RtmWrenchItem::new
    );
    public static final RegistryObject<WireItem> WIRE_ITEM = ITEMS.register(
        "wire", WireItem::new
    );
    // 照明(light): 本家RTM の照明アイテム。外部パックのモデルを使用し、レッドストーン
    // 信号を受けると点灯する(InstalledObjectBlock 側で発光処理)。
    public static final RegistryObject<InstalledObjectItem> LIGHT_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<InstalledObjectItem> SIGNBOARD_ITEM = ITEMS.register(
        "signboard", () -> new InstalledObjectItem(InstalledObjectCategory.SIGNBOARD)
    );
    public static final RegistryObject<InstalledObjectItem> PIPE_ITEM = ITEMS.register(
        "pipe", () -> new InstalledObjectItem(InstalledObjectCategory.PIPE)
    );
    public static final RegistryObject<InstalledObjectItem> INSULATOR_ITEM = ITEMS.register(
        "insulator", () -> new InstalledObjectItem(InstalledObjectCategory.INSULATOR)
    );
    public static final RegistryObject<InstalledObjectItem> SIGNAL_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<InstalledObjectItem> TRAIN_DETECTOR_ITEM = ITEMS.register(
        "train_detector", () -> new InstalledObjectItem(InstalledObjectCategory.TRAIN_DETECTOR)
    );
    public static final RegistryObject<InstalledObjectItem> OVERHEAD_LINE_POLE_ITEM = ITEMS.register(
        "overhead_line_pole", () -> new InstalledObjectItem(InstalledObjectCategory.OVERHEAD_LINE_POLE)
    );
    public static final RegistryObject<InstalledObjectItem> TICKET_GATE_ITEM = ITEMS.register(
        "ticket_gate", () -> new InstalledObjectItem(InstalledObjectCategory.TICKET_GATE)
    );
    public static final RegistryObject<InstalledObjectItem> SPEAKER_ITEM = ITEMS.register(
        "speaker", () -> new InstalledObjectItem(InstalledObjectCategory.SPEAKER)
    );
    //本家 electric: 入力/出力コネクタ (配線網⇔レッドストーン)
    public static final RegistryObject<InstalledObjectItem> CONNECTOR_INPUT_ITEM = ITEMS.register(
        "connector_input", () -> new InstalledObjectItem(InstalledObjectCategory.CONNECTOR_INPUT)
    );
    public static final RegistryObject<InstalledObjectItem> CONNECTOR_OUTPUT_ITEM = ITEMS.register(
        "connector_output", () -> new InstalledObjectItem(InstalledObjectCategory.CONNECTOR_OUTPUT)
    );
    //本家 electric: 信号変換器
    public static final RegistryObject<net.minecraft.world.item.BlockItem> SIGNAL_CONVERTER_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<InstalledObjectItem> FLUORESCENT_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<InstalledObjectItem> RAILROAD_SIGN_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<InstalledObjectItem> BUMPING_POST_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<InstalledObjectItem> POINT_MACHINE_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<InstalledObjectItem> TICKET_VENDOR_ITEM = ITEMS.register(
        "ticket_vendor", () -> new InstalledObjectItem(InstalledObjectCategory.TICKET_VENDOR)
    );
    //本家 ItemCamera: 撮り鉄用カメラ (望遠 / 被写界深度 / 流し撮り / 列車追尾AF)
    public static final RegistryObject<com.portofino.realtrainmodunofficial.item.CameraItem> CAMERA_ITEM = ITEMS.register(
        "camera", com.portofino.realtrainmodunofficial.item.CameraItem::new
    );
    //本家 ItemTicket: 券売機が発券し改札が消費する。切符=1回, 回数券=11回。
    public static final RegistryObject<com.portofino.realtrainmodunofficial.item.TicketItem> TICKET_ITEM = ITEMS.register(
        "ticket", () -> new com.portofino.realtrainmodunofficial.item.TicketItem(1)
    );
    public static final RegistryObject<com.portofino.realtrainmodunofficial.item.TicketItem> TICKET_BOOK_ITEM = ITEMS.register(
        "ticket_book", () -> new com.portofino.realtrainmodunofficial.item.TicketItem(11)
    );

    //SignalControllerMod (masa300) 移植: 信号制御器 + 位置設定ツール×2
    public static final RegistryObject<net.minecraft.world.item.BlockItem> SIGNAL_CONTROLLER_ITEM = ITEMS.register(
    ...
    public static final RegistryObject<jp.masa.signalcontrollermod.ItemPosSettingTool> POS_SETTING_TOOL_0 = ITEMS.register(
        "pos_setting_tool_0", () -> new jp.masa.signalcontrollermod.ItemPosSettingTool(0)
    );
    public static final RegistryObject<jp.masa.signalcontrollermod.ItemPosSettingTool> POS_SETTING_TOOL_1 = ITEMS.register(
