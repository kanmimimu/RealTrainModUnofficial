...
public class Config {
    ...
    public static final ForgeConfigSpec.IntValue MODEL_CACHE_PROTECT_SECONDS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue RAIL_MARKER_SEARCH_RANGE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue RAIL_MARKER_SEARCH_HEIGHT = BUILDER
