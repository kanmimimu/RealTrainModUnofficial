...
public final class RTMRailBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<TileEntityLargeRailBase>> LARGE_RAIL_BASE =
    ...
    public static final RegistryObject<BlockEntityType<TileEntityLargeRailNormalCore>> LARGE_RAIL_NORMAL_CORE =
    ...
    public static final RegistryObject<BlockEntityType<TileEntityLargeRailSwitchBase>> LARGE_RAIL_SWITCH_BASE =
    ...
    public static final RegistryObject<BlockEntityType<TileEntityLargeRailSwitchCore>> LARGE_RAIL_SWITCH_CORE =
    ...
    public static final RegistryObject<BlockEntityType<TileEntityLargeRailSlopeBase>> LARGE_RAIL_SLOPE_BASE =
    ...
    public static final RegistryObject<BlockEntityType<TileEntityLargeRailSlopeCore>> LARGE_RAIL_SLOPE_CORE =
    ...
    public static final RegistryObject<BlockEntityType<TileEntityTurnTableCore>> TURNTABLE_CORE =
    ...
    public static final RegistryObject<BlockEntityType<TileEntityMarker>> MARKER =
