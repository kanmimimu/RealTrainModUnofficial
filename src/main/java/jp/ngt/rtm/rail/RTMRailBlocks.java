...
public final class RTMRailBlocks {
    public static final DeferredRegister<Block> REGISTER = DeferredRegister.create(Registries.BLOCK, RealTrainModUnofficial.MODID);

    //本家: largeRailBase0 (rtm:LRBase)
    public static final RegistryObject<BlockLargeRailBase> LARGE_RAIL_BASE =
            REGISTER.register("large_rail_base", () -> new BlockLargeRailBase(2, BlockBehaviour.Properties.of()));
    //本家: largeRailCore0 (rtm:LRCore)
    public static final RegistryObject<BlockLargeRailCore> LARGE_RAIL_NORMAL_CORE =
    ...
    public static final RegistryObject<BlockLargeRailSwitchBase> LARGE_RAIL_SWITCH_BASE =
    ...
    public static final RegistryObject<BlockLargeRailSwitchCore> LARGE_RAIL_SWITCH_CORE =
    ...
    public static final RegistryObject<BlockLargeRailSlopeBase> LARGE_RAIL_SLOPE_BASE =
            REGISTER.register("large_rail_slope_base", () -> new BlockLargeRailSlopeBase(2, BlockBehaviour.Properties.of()));
    //本家: largeRailSlopeCore0
    public static final RegistryObject<BlockLargeRailSlopeCore> LARGE_RAIL_SLOPE_CORE =
